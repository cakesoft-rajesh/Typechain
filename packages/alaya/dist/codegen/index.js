...
function codegenContractTypings(contract, codegenConfig) {
  ...
  export interface ${contract.name} extends Contract {
    ...
    const imports = (0, typechain_1.createImportsForUsedIdentifiers)({
        '@alayanetwork/ethers-providers/packages/ethers/src.ts': [
            'Contract',
            'BigNumber',
            'BigNumberish',
            'BytesLike',
        ...
        '@alayanetwork/ethers-providers/packages/abi/src.ts': ['FunctionFragment', 'Result', 'EventFragment'],
        '@alayanetwork/ethers-providers/packages/providers/src.ts': ['Listener', 'Provider'],
    }, source) +
        '\n' +
...
function codegenContractFactory(contract, abi, bytecode) {
  ...
  `;
    const imports = (0, typechain_1.createImportsForUsedIdentifiers)({
        ...
        '@alayanetwork/ethers-providers/packages/providers/src.ts': ['Provider', 'TransactionRequest'],
    }, source);
    return imports + source;
}
...
function codegenAbstractContractFactory(contract, abi) {
    const { body, header } = codegenCommonContractFactory(contract, abi);
    return `
  import { Contract, Signer, utils } from "@alayanetwork/ethers-providers/packages/ethers/src.ts";
  import { Provider } from "@alayanetwork/ethers-providers/packages/providers/src.ts";
  ${header}
